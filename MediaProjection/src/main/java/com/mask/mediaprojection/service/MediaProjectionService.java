...
//        mediaFile = new File(dirFile, FileUtils.getDateName("MediaRecorder") + ".mp4");
        String dir = Environment.getExternalStorageDirectory ().getAbsolutePath() + "/LuKe/Video/"; //图片保存的文件夹名
        ...
        //将要保存的图片文件
        File mediaFile = new File(dir + getNowDate());
    ...
    public void stopRecording() {
        ...
        if (mediaRecorderCallback != null) {
            mediaRecorderCallback.onSuccess("保存成功");
        }
        mediaFile = null;
